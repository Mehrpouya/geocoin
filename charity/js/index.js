...
function addCharityZone(){
  var zoneName = prompt("Please give a short name or description for this zone");
  if(zoneName===null || zoneName==="")
    console.log("user canceld")
  else{
      addZoneToDb(zoneName);
    }
}

function addZoneToDb(_zoneDesc){
  var myurl = "http://geocoin.eca.ed.ac.uk/addCharityZone.php";
  console.log(myurl);
  var inputs =  { uniqueId:g_user.getUserId(),
