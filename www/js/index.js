...
function addLayer(){
    ...
    var mapLayer = new L.TileLayer(layerUrl, {minZoom: 18, maxZoom: 20, attribution: attrib});
    // start the map in South-East England
    g_map.setView(new L.LatLng(55.934779444089145,-3.333878517150879 ),18);
